...
interface DataTableProps<TData, TValue> {
  ...
  tipoDependencias?: TipoDependencia[]; // Propiedad adicional
  sectores?: Sector[]; // Propiedad adicional
}

export function DataTable<TData, TValue>({
  columns,
  data,
  tipoDependencias = [], // Valor predeterminado
  sectores = [], // Valor predeterminado
  children,
  ...
  const table = useReactTable({
    ...
    meta: {
      tipoDependencias,
      sectores,
    }, // Pasamos estas props al contexto de las columnas
  });
