...
export const columns: ColumnDef<IndicePresupestrario>[] = [
  {
    accessorKey: "nombre",
  ...
  },
  {
    ...
    header: () => <div className="text-left">Subtitulo</div>,
  },
  {
    accessorKey: "asignacion",
    header: () => <div className="text-left">Asignación</div>,
  },
  {
  ...
  },
  {
    id: "actions",
    cell: ({ row, table }) => {
      const IndicePresupestrario = row.original;
            ...
            <AlertDialogContent className="w-[95%]">
              <AlertDialogHeader>
                <div className="flex justify-between items-center">
                  <AlertDialogTitle>
                    Actualice indice presupuestario
                  </AlertDialogTitle>
                  <AlertDialogCancel>
                    <AiOutlineClose />
                  </AlertDialogCancel>
                ...
                <div>
                  <UpdateIndicePresupuestarioGrid
          ...
          <AlertDialog open={deleteItem} onOpenChange={setDeleteItem}>
            <AlertDialogContent className="w-[95%]">
              <AlertDialogHeader>
                <div className="flex justify-between items-center">
                  <AlertDialogTitle>
                    Eliminar indice presupuestario
                  </AlertDialogTitle>
                  <AlertDialogCancel>
                    <AiOutlineClose />
                  </AlertDialogCancel>
                ...
                <AlertDialogDescription>
                  ¿Seguro quieres eliminar este indice presupuestario?
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
